...
namespace CandeeCamp.API.Migrations
{
    ...
    [Migration("20191213141108_snack-shop-items-updates")]
    partial class snackshopitemsupdates
    {
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.Camper", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 9, 11, 8, 113, DateTimeKind.Unspecified).AddTicks(3930), new TimeSpan(0, -5, 0, 0, 0)),
                            FirstName = "Jocelyn",
                            IsActive = true,
                            IsDeleted = false,
                            LastName = "Lacombe",
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 9, 11, 8, 113, DateTimeKind.Unspecified).AddTicks(3960), new TimeSpan(0, -5, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CreatedBy = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 14, 11, 8, 112, DateTimeKind.Unspecified).AddTicks(8320), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 9, 11, 8, 95, DateTimeKind.Unspecified).AddTicks(1780), new TimeSpan(0, -5, 0, 0, 0)),
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 9, 11, 8, 111, DateTimeKind.Unspecified).AddTicks(2460), new TimeSpan(0, -5, 0, 0, 0))
                        },
                        new
                        {
                            Id = -2,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 9, 11, 8, 112, DateTimeKind.Unspecified).AddTicks(6940), new TimeSpan(0, -5, 0, 0, 0)),
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 9, 11, 8, 112, DateTimeKind.Unspecified).AddTicks(6950), new TimeSpan(0, -5, 0, 0, 0))
                        });
                });
