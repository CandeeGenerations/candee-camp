...
namespace CandeeCamp.API.Migrations
{
    ...
    [Migration("20200116122101_auth_client")]
    partial class auth_client
    {
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.AuthClient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientSecret = "lp3JeUxAgho6yuV5dZbqqMw4F6lzgY",
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 16, 7, 21, 0, 952, DateTimeKind.Unspecified).AddTicks(3530), new TimeSpan(0, -5, 0, 0, 0)),
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2020, 1, 16, 7, 21, 0, 965, DateTimeKind.Unspecified).AddTicks(6790), new TimeSpan(0, -5, 0, 0, 0))
                        });
                });
