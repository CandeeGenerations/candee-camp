...
namespace Reclaimed.API.Migrations
{
    ...
    [Migration("20200117172154_setting-values")]
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.AuthClient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientSecret = "xROeQt0riBsMqIOs63sNjpqDJnlIER",
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 17, 12, 21, 53, 751, DateTimeKind.Unspecified).AddTicks(9050), new TimeSpan(0, -5, 0, 0, 0)),
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2020, 1, 17, 12, 21, 53, 765, DateTimeKind.Unspecified).AddTicks(1080), new TimeSpan(0, -5, 0, 0, 0))
                        });
                });
