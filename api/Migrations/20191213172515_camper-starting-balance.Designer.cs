...
namespace CandeeCamp.API.Migrations
{
    ...
    [Migration("20191213172515_camper-starting-balance")]
    partial class camperstartingbalance
    {
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.Camper", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 12, 25, 14, 999, DateTimeKind.Unspecified).AddTicks(1060), new TimeSpan(0, -5, 0, 0, 0)),
                            FirstName = "Jocelyn",
                            IsActive = true,
                            IsDeleted = false,
                            LastName = "Lacombe",
                            ...
                            StartingBalance = 0m,
                            UpdatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 12, 25, 14, 999, DateTimeKind.Unspecified).AddTicks(1090), new TimeSpan(0, -5, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CreatedBy = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 17, 25, 14, 998, DateTimeKind.Unspecified).AddTicks(4710), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 12, 25, 14, 981, DateTimeKind.Unspecified).AddTicks(9570), new TimeSpan(0, -5, 0, 0, 0)),
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 12, 25, 14, 996, DateTimeKind.Unspecified).AddTicks(5640), new TimeSpan(0, -5, 0, 0, 0))
                        },
                        new
                        {
                            Id = -2,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 12, 25, 14, 998, DateTimeKind.Unspecified).AddTicks(2690), new TimeSpan(0, -5, 0, 0, 0)),
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2019, 12, 13, 12, 25, 14, 998, DateTimeKind.Unspecified).AddTicks(2710), new TimeSpan(0, -5, 0, 0, 0))
                        });
                });
