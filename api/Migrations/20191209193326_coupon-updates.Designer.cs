...
namespace Reclaimed.API.Migrations
{
    ...
    [Migration("20191209193326_coupon-updates")]
    partial class couponupdates
    {
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.Camper", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 9, 14, 33, 25, 565, DateTimeKind.Unspecified).AddTicks(6160), new TimeSpan(0, -5, 0, 0, 0)),
                            FirstName = "Jocelyn",
                            IsActive = true,
                            IsDeleted = false,
                            LastName = "Lacombe",
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2019, 12, 9, 14, 33, 25, 565, DateTimeKind.Unspecified).AddTicks(6200), new TimeSpan(0, -5, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CreatedBy = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 9, 19, 33, 25, 564, DateTimeKind.Unspecified).AddTicks(8900), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 9, 14, 33, 25, 549, DateTimeKind.Unspecified).AddTicks(3300), new TimeSpan(0, -5, 0, 0, 0)),
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2019, 12, 9, 14, 33, 25, 562, DateTimeKind.Unspecified).AddTicks(9070), new TimeSpan(0, -5, 0, 0, 0))
                        },
                        new
                        {
                            Id = -2,
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 12, 9, 14, 33, 25, 564, DateTimeKind.Unspecified).AddTicks(7180), new TimeSpan(0, -5, 0, 0, 0)),
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2019, 12, 9, 14, 33, 25, 564, DateTimeKind.Unspecified).AddTicks(7200), new TimeSpan(0, -5, 0, 0, 0))
                        });
                });
