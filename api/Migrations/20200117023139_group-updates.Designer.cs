...
namespace Reclaimed.API.Migrations
{
    ...
    [Migration("20200117023139_group-updates")]
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.AuthClient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientSecret = "mcTxzHc9grANxJuqF0jIcj7JVTVr8d",
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 16, 21, 31, 39, 285, DateTimeKind.Unspecified).AddTicks(4950), new TimeSpan(0, -5, 0, 0, 0)),
                            ...
                            UpdatedDate = new DateTimeOffset(new DateTime(2020, 1, 16, 21, 31, 39, 299, DateTimeKind.Unspecified).AddTicks(370), new TimeSpan(0, -5, 0, 0, 0))
                        });
                });
